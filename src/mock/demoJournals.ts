...
export const demoJournals: JournalEntry[] = [
  {
    ...
    timestamp: daysAgo(0),
    input:
      'Had mock test today. Got 180/360. I know what went wrong — thermodynamics. Feeling anxious but also motivated to fix it.',
    mode: 'journal',
    ...
    burnoutRisk: 'medium',
    aiResponse:
      "Your ability to identify exactly what went wrong shows real analytical strength. Many students panic after a mock test — you're already ahead by pinpointing thermodynamics as the gap.",
    copingStrategies: [
    ...
    mindfulnessExercise:
      '4-7-8 breathing: Inhale for 4, hold for 7, exhale for 8. This activates your parasympathetic nervous system before sleep.',
  },
  {
    id: 'demo-j-2',
    timestamp: daysAgo(1),
    input:
      "Couldn't sleep last night thinking about JEE. Kept comparing myself to Rahul who's already done with organic chemistry revision twice.",
    mode: 'journal',
    ...
    burnoutRisk: 'high',
    aiResponse:
      "Comparison with peers is one of the most common JEE stress triggers I see. Rahul's pace is Rahul's — your retention and understanding matter more than revision count.",
    copingStrategies: [
    ...
    mindfulnessExercise:
      'Progressive muscle relaxation: Tense each muscle group for 5 seconds then release, starting from your toes up to your forehead.',
  },
  {
    id: 'demo-j-3',
    timestamp: daysAgo(2),
    ...
    burnoutRisk: 'low',
    aiResponse:
      'This is the Arjun who will crack JEE. Completing integration fully is a significant milestone. Keep this momentum — note exactly what made today work.',
    copingStrategies: [
    ...
    mindfulnessExercise:
      'Mindful appreciation: Sit quietly for 2 minutes and notice 3 things you did well today.',
  },
  {
    id: 'demo-j-4',
    timestamp: daysAgo(3),
    input:
      'Physics is destroying me. Rotational dynamics questions make no sense. Spent 3 hours and solved only 2 problems correctly.',
    mode: 'journal',
    ...
    burnoutRisk: 'medium',
    aiResponse:
      "Three hours on rotational dynamics and only 2 correct problems — that's not failure, that's identifying a conceptual gap before the exam does. This is exactly the right time to find this.",
    copingStrategies: [
    ...
    mindfulnessExercise:
      'Box breathing: Inhale 4 counts, hold 4, exhale 4, hold 4. Do 3 rounds to reset focus.',
  },
  {
    id: 'demo-j-5',
    timestamp: daysAgo(5),
    input:
      'Quiz scenario: Lower mock score. I felt like avoiding the paper and distracting myself.',
    mode: 'quiz',
    ...
    burnoutRisk: 'medium',
    aiResponse:
      'Avoidance after a disappointing score is a very human response. The instinct to protect yourself from further disappointment makes sense. But you reached out here — that shows self-awareness.',
    copingStrategies: [
    ...
    mindfulnessExercise:
      'Grounding technique: Name 5 things you can see, 4 you can touch, 3 you can hear. This breaks the avoidance spiral.',
  },
  {
    id: 'demo-j-6',
    timestamp: daysAgo(6),
    ...
    burnoutRisk: 'low',
    aiResponse:
      "Clearing 3 physical chemistry chapters in a day is excellent progress. Physical chemistry is JEE's hidden scorer — your preparation here will pay off.",
    copingStrategies: [
    ...
    mindfulnessExercise:
      'Gratitude breathing: With each exhale, think of one thing that went well today.',
  },
  {
    id: 'demo-j-7',
    timestamp: daysAgo(7),
    input:
      'Family pressure is building. Parents keep asking about my rank prediction. I feel suffocated.',
    mode: 'journal',
    ...
    burnoutRisk: 'medium',
    aiResponse:
      "Family pressure on top of exam stress is a double burden. Your parents' questions come from care, even when it doesn't feel that way. Having a conversation about boundaries can reduce this significantly.",
    copingStrategies: [
    ...
    mindfulnessExercise:
      "Body scan: Sit still for 3 minutes and notice where you're holding tension. Consciously breathe into that area and release.",
  },
];
...
export const demoWeeklyInsight: WeeklyInsight = {
  ...
  progressNote:
    'This week showed your full range — from 2/10 stress on your best day to 8/10 on your worst. What stands out is your ability to identify root causes. That metacognitive skill is exactly what separates top JEE scorers.',
