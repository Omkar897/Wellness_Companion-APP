...
const EMOTION_COLORS: Record<string, string> = {
  anxiety: '#f97316', frustration: '#ef4444', panic: '#dc2626',
  sadness: '#3b82f6', self_doubt: '#8b5cf6', hope: '#22c55e',
  motivation: '#10b981', confidence: '#7c3aed', calm: '#06b6d4',
  focus: '#a78bfa', pressure: '#f59e0b', guilt: '#6b7280',
};
...
function CustomBar(props: { x?: number; y?: number; width?: number; height?: number; emotion?: string }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={200}>
      <BarChart data={chartData} layout="vertical" margin={{ left: 10, right: 20, top: 5, bottom: 5 }}>
        ...
        />
        <Tooltip
          contentStyle={{ background: 'rgba(15,10,30,0.9)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8 }}
