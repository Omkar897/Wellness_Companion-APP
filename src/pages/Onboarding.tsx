...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      {/* Background */}
      <div
        className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(124,58,237,0.15)_0%,transparent_60%)]"
        aria-hidden
      />
        ...
        <AnimatePresence mode="wait">
          {step === 0 && (
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-8">
                Understand your stress patterns, detect burnout before it hits, and get personalized
                coping strategies — all powered by AI trained for exam students.
              </p>
              <div className="flex flex-col gap-3">
                ...
                <p className="text-xs text-white/30">
                  No sign-up required. All data stays on your device.
                </p>
              </div>
            </motion.div>
          )}
          ...
          {step === 1 && (
            ...
            >
              ...
              <p className="text-white/50 text-sm mb-6">
                Your companion will personalize everything for you.
              </p>
              <Input
                label="Your name"
          ...
          {step === 2 && (
            ...
            >
              ...
              <p className="text-white/50 text-sm mb-6">
                This helps me give you context-aware support.
              </p>
          ...
          {step === 3 && (
            ...
            >
              ...
              <p className="text-white/60 text-sm mb-8 leading-relaxed">
                Start by logging how you feel today. Your AI companion will analyze patterns and
                give you personalized support as you prepare.
              </p>
